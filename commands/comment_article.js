...
export default async (event) => {
  try {
    let name = ''
    const topicArr = [{ chi: '!討論 英雄聯盟', eng: '!comment lol', url: 'lol' }, { chi: '!討論 綜合遊戲討論', eng: '!comment gaming', url: 'gaming' }, { chi: '!討論 Apex英雄', eng: '!comment apex', url: 'apexleagues' }, { chi: '!討論 寶可夢', eng: '!comment pokemon', url: 'pokemon' }, { chi: '!討論 鬥陣特工', eng: '!comment overwatch', url: 'overwatch' }, { chi: '!討論 steam', eng: '!comment steam', url: 'steam' }, { chi: '!討論 聯盟戰旗', eng: '!comment tft', url: 'TFT' }, { chi: '!討論 遊戲王', eng: '!comment yugioh', url: 'yugioh' }, { chi: '!討論 爐石戰記', eng: '!comment hs', url: 'hs' }, { chi: '!討論 激鬥峽谷', eng: '!comment lolm', url: 'lolm' }, { chi: '!討論 特戰英豪', eng: '!comment valorant', url: 'valorant' }, { chi: '!討論 傳說對決', eng: '!comment aov', url: 'moba' }, { chi: '!討論 俠盜獵車手', eng: '!comment gta', url: 'gta' }, { chi: '!討論 絕地求生', eng: '!comment pubg', url: 'PUBG' }, { chi: '!討論 絕對武力CS:GO', eng: '!comment csgo', url: 'csgo' }, { chi: '!討論 手遊綜合討論', eng: '!comment mobilegame', url: 'mobileGame' }, { chi: '!討論 福利', eng: '!comment hso', url: 'hotchick/' }, { chi: '!討論 八卦新聞', eng: '!comment gossiping', url: 'gossiping' }, { chi: '!討論 休閒娛樂', eng: '!comment funny', url: 'funny' }, { chi: '!討論 電影', eng: '!comment movie', url: 'movie' }, { chi: '!討論 寵物', eng: '!comment pet', url: 'pet' }, { chi: '!討論 動漫', eng: '!comment acg', url: 'acg' }, { chi: '!討論 3C', eng: '!comment 3c', url: '3c' }, { chi: '!討論 運動', eng: '!comment sport', url: 'sport' }, { chi: '!討論 迷因', eng: '!comment meme', url: 'meme' }]
